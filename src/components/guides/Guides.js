        ...
        <div className="guide-container">
          <div className="guide">
            ...
            <Typography use="caption" tag="p" className="secondary">
              ...
              place to IC, it is a tracker of ICs and GBs. There is also a minimum requirement of a render/photograph of
              the keycaps on a board. This is to ensure a consistent look across the site.
            </Typography>
            <Typography use="headline5" tag="h2">
              Edit
            </Typography>
          ...
          <div className="guide">
            ...
            <Typography use="body2" tag="p">
              The name of the designer (either well-known name, or forum username). If the set is a collaboration, this
              can include multiple designers by separating each with a comma (the site will add a space after a comma -
              make sure not to add an extra one).
            </Typography>
            <Typography use="caption" tag="p" className="secondary">
            ...
            <Typography use="caption" tag="p" className="secondary">
              You don’t have to be too strict with this. As long as there are pictures of the set by customers (not the
              designer or vendors), it should be fine to confirm.
            </Typography>
            <Typography use="headline5" tag="h2">
              Vendors
            </Typography>
            ...
            <Typography use="caption" tag="p" className="secondary">
              Use the autocomplete suggestions to ensure that the formatting is consistent with other sets (e.g. Cannon
              Keys not CannonKeys).
            </Typography>
            <Typography use="subtitle1" tag="h4">
              Region*
            ...
            <Typography use="caption" tag="p" className="secondary">
              If the vendor is covering multiple regions, separate each region with a comma. If a single vendor covers
              all regions, then enter “Global”. Common regions are listed below.
            </Typography>
            ...
            <Typography use="caption" tag="p" className="secondary">
              <sup>†</sup>Unless there are separate vendors for these regions, such as proto[Typist] and MyKeyboard on
              the same set.
            </Typography>
            <Typography use="caption" tag="p" className="secondary">
